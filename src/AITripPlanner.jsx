    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10  backdrop-blur-md rounded-3xl p-2 mb-8 border-5 border-white shadow-lg ">
            <div className="flex items-center justify-between">
              {[1, 2, 3, 4].map((step) => (
                <div key={step} className="flex items-center flex-1">
                  <div className={`w-12 h-12 border-6 border-white shadow-lg   rounded-full flex items-center justify-center font-bold transition-all duration-300 ${
                    currentStep >= step ? 'bg-green-500 text-white' : 'bg-white/20 text-black/60'
                  }`}>
                    {step}
                  </div>
                  {step < 4 && (
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 min-h-[500px]">
            ...
            {currentStep === 2 && (
            <div className="space-y-6">
            <h2 className="text-3xl font-bold text-black-800 text-center mb-8">What type of trip are you looking for?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {tripTypes.map((type) => {
